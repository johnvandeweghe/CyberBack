 ...
 */
final class Version20180909033249 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        , attack INTEGER NOT NULL, defense INTEGER NOT NULL, health INTEGER NOT NULL, unit_type VARCHAR(255) NOT NULL, min_range INTEGER NOT NULL, max_range INTEGER NOT NULL, speed INTEGER NOT NULL, x_position INTEGER DEFAULT NULL, y_position INTEGER DEFAULT NULL, game_id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO unit (id, player_id, attack, defense, health, unit_type, min_range, max_range, speed, x_position, y_position) SELECT id, player_id, attack, defense, health, unit_type, min_range, max_range, speed, x_position, y_position FROM __temp__unit');
        $this->addSql('DROP TABLE __temp__unit');
        $this->addSql('CREATE INDEX IDX_DCBB0C5399E6F5DF ON unit (player_id)');
