 ...
 */
final class Version20180909033124 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DCBB0C53E48FD905');
        $this->addSql('CREATE TEMPORARY TABLE __temp__unit AS SELECT id, game_id, attack, defense, health, unit_type, min_range, max_range, speed, x_position, y_position FROM unit');
        ...
        , attack INTEGER NOT NULL, defense INTEGER NOT NULL, health INTEGER NOT NULL, unit_type VARCHAR(255) NOT NULL COLLATE BINARY, min_range INTEGER NOT NULL, max_range INTEGER NOT NULL, speed INTEGER NOT NULL, x_position INTEGER DEFAULT NULL, y_position INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_DCBB0C53E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DCBB0C5399E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO unit (id, game_id, attack, defense, health, unit_type, min_range, max_range, speed, x_position, y_position) SELECT id, game_id, attack, defense, health, unit_type, min_range, max_range, speed, x_position, y_position FROM __temp__unit');
